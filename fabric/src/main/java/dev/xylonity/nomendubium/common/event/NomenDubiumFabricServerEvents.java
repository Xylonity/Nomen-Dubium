...
public final class NomenDubiumFabricServerEvents {
    ...
    private static void registerCoaldenWood() {
        StrippableBlockRegistry.register(NomenDubiumBlocks.COALDEN_LOG.get(), NomenDubiumBlocks.COALDEN_STRIPPED_LOG.get());
        StrippableBlockRegistry.register(NomenDubiumBlocks.COALDEN_WOOD.get(), NomenDubiumBlocks.COALDEN_STRIPPED_WOOD.get());
