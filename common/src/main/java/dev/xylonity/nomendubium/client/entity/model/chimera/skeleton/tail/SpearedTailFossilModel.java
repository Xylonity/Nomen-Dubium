...
public final class SpearedTailFossilModel extends EntityModel<SkeletonPartRenderState> {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 9.0F, 30.0F, new CubeDeformation(0.0F)), ChimeraModelConnections.alignToConnection(0.0F, 5.0F, 2.0F, 0.5236F, 0.0F, 0.0F));
		...
		PartDefinition body_connection = tail.addOrReplaceChild("body_connection", CubeListBuilder.create(), PartPose.offset(0.0F, 5.0F, 2.0F));
