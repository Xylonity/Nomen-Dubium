...
public final class SpineSailFossilModel extends NomenDubiumEntityModel<SkeletonPartEntity> {

    public SpineSailFossilModel(ModelPart root) {
        super(root);
    }
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition sail = partdefinition.addOrReplaceChild("sail", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -16.0F, -16.0F, 0.0F, 16.0F, 32.0F, new CubeDeformation(0.0F)), ChimeraModelConnections.alignToConnection(0.0F, 0.0F, 0.0F));
