...
public final class SpineSailModel extends NomenDubiumEntityModel<ChimeraEntity> {
	...
	public static LayerDefinition createLayer() {
		...
		.texOffs(0, 0).addBox(-1.0F, -15.0F, -8.0F, 2.0F, 15.0F, 16.0F, new CubeDeformation(0.0F)), ChimeraModelConnections.alignToConnection(0.0F, 0.0F, 0.0F));
