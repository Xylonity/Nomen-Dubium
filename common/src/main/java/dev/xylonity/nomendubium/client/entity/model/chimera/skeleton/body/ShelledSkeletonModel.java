...
public final class ShelledSkeletonModel extends NomenDubiumEntityModel<SkeletonPartEntity> {

    public ShelledSkeletonModel(ModelPart root) {
        super(root);
    }
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition head_connection = body.addOrReplaceChild("head_connection", CubeListBuilder.create(), PartPose.offset(0.0F, -9.0F, 25.0F));

		PartDefinition tail_connection = body.addOrReplaceChild("tail_connection", CubeListBuilder.create(), PartPose.offset(0.0F, -8.0F, -22.0F));

		PartDefinition extra_connection = body.addOrReplaceChild("extra_connection", CubeListBuilder.create(), PartPose.offset(0.0F, -39.0F, 2.0F));
